...
if (first < second) and (first < third) and (first < last) :
    print("\t",first,"is THE SMALLEST DIGIT in",num_org)
elif (second < first) and (second < third) and (second < last):
    print("\t",second,"is THE SMALLEST DIGIT in",num_org)
elif (third < first) and (third < second) and (third < last):
    print("\t",third,"is THE SMALLEST DIGIT in",num_org)
else:
    print("\t",last,"is THE SMALLEST DIGIT in",num_org)